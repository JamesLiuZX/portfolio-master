...
function Hero() {
  return (
    <>
      ...
      >
        <p className="text-xl mb-5">Hi I'm James Liu.</p>
        
        <h1 className="heroTitle inline-block max-w-2xl lg:max-w-4xl  w-auto relative text-5xl md:text-6xl lg:text-7xl tracking-tighter mb-10 font-bold heroShinyBg">
          <span className="heroShiny1 text-fun-pink">Fullstack</span> Dev and{" \n"}
          <span className="heroShiny2 text-fun-pink">Penultimate</span> NUS CS.
          <img
